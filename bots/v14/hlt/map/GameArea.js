...
class GameArea {
    ...
    calculateDistanceBetweenAreaAndPosition (_areaId, _position) {
        return this.gameMap.calculateManhattanDistanceToMultiplePositions(_position, this.areas[_areaId].centerPositions);
    }
